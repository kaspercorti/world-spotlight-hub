...
export function FiltersPanel(props: Props) {
  return (
    <div className="pointer-events-auto absolute bottom-4 left-1/2 z-[1000] w-[min(720px,calc(100vw-2rem))] -translate-x-1/2 rounded-lg border border-border bg-card/85 p-3 backdrop-blur-md shadow-panel animate-fade-in">
